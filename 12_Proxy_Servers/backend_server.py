...
@legacy_backend_mcp.tool(
    description="Greets a person by name from the legacy SSE system."
)
...
if __name__ == "__main__":
    ...
    backend_port = 9001
    print(
        f"Starting Legacy Backend Server ({legacy_backend_mcp.name}) on http://{backend_host}:{backend_port}/mcp (offering SSE)"
    )
